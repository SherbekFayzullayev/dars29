...
class _MyAppState extends State<MyApp> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          backgroundColor: const Color.fromARGB(255, 60, 152, 227),
          title: Text(
            'Switch List',
        ...
        body: Column(
          children: [
            Container(
              color: a == false
                  ? Colors.white
                  : const Color.fromARGB(255, 63, 219, 68),
              child: ListTile(
                title: Text('Title0'),
            ...
            Container(
              color: a1 == false
                  ? Colors.white
                  : const Color.fromARGB(255, 62, 210, 67),
              child: ListTile(
                title: Text('Title1'),
            ...
            Container(
              color: a2 == false
                  ? Colors.white
                  : const Color.fromARGB(255, 65, 220, 70),
              child: ListTile(
                title: Text('Title2'),
            ...
            Container(
              color: a3 == false
                  ? Colors.white
                  : const Color.fromARGB(255, 71, 211, 76),
              child: ListTile(
                title: Text('Title3'),
            ...
            Container(
              color: a5 == false
                  ? Colors.white
                  : const Color.fromARGB(255, 68, 234, 73),
              child: ListTile(
                title: Text('Title5'),
            ...
            Container(
              color:
                  a6 == false ? Colors.white : Color.fromARGB(255, 57, 207, 62),
              child: ListTile(
                title: Text('Title6'),
            ...
            Container(
              color: a7 == false
                  ? Colors.white
                  : const Color.fromARGB(255, 40, 224, 46),
              child: ListTile(
                title: Text('Title7'),
            ...
            Container(
              color: a8 == false
                  ? Colors.white
                  : const Color.fromARGB(255, 60, 202, 64),
              child: ListTile(
                title: Text('Title8'),
            ...
            Container(
              color: a9 == false
                  ? Colors.white
                  : const Color.fromARGB(255, 57, 205, 62),
              child: ListTile(
                title: Text('Title9'),
